...
from function_tools.crew_tools import (
    classify_user_request_tool,
    create_agent_work_plan_tool,
    summarize_chat_history_tool,
    validate_final_response_tool,
    estimate_context_usage_tool,
    profile_dataframe_tool,
    suggest_kpi_metrics_tool,
    generate_dashboard_layout_tool,
    validate_sql_tool,
    explain_query_result_tool,
    recommend_ml_problem_type_tool,
    suggest_feature_engineering_tool,
    detect_ml_data_risks_tool,
    recommend_evaluation_metrics_tool,
    create_ml_pipeline_plan_tool,
)
...
def build_agent_from_yaml(
    ...
    # -------------------------------
    # Assign tools based on agent
    # -------------------------------

    tools = []

    if agent_key == "supervisor_agent":
    # Manager agents in CrewAI hierarchical mode cannot have tools.
         tools = []
    elif agent_key == "data_analyst_agent":
    ...
    elif agent_key == "data_scientist_agent":
